...
export class LazyForDirective implements DoCheck, OnInit {
  ...
  lazyForContainer: HTMLElement = new HTMLElement();
  ...
  private templateElem: HTMLElement = new HTMLElement();

  private beforeListElem: HTMLElement = new HTMLElement();
  private afterListElem: HTMLElement = new HTMLElement();
  ...
  constructor(private vcr: ViewContainerRef,
    ...
    this.itemHeight = 0;
    this.itemTagName = '';
    this.differ = this.iterableDiffers.find([]).create();
  }
  ...
  private onFirstUpdate(): void {
    ...
    let sampleItemElem: HTMLElement = new HTMLElement();
